	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got.IsCompleted != tt.want.IsCompleted {
				t.Errorf("NewTask() IsCompleted = %v, want %v", got.IsCompleted, tt.want.IsCompleted)
			}
...
func TestTaskMarkCompleted(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ti.MarkCompleted()
			if !ti.IsCompleted {
				t.Errorf("MarkCompleted() IsCompleted = %v, want %v", ti.IsCompleted, true)
			}
...
func TestTaskMarkNotCompleted(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ti.MarkNotCompleted()
			if ti.IsCompleted {
				t.Errorf("MarkNotCompleted() IsCompleted = %v, want %v", ti.IsCompleted, false)
			}
			if ti.UpdatedAt.IsZero() {
