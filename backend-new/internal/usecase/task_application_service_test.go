...
func TestTaskUseCaseCreate(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err == nil && newTask.IsCompleted != tt.want.IsCompleted {
				t.Errorf("s.CreateTask() IsCompleted = %v, want %v", newTask.IsCompleted, tt.want.IsCompleted)
			}
...
func TestTaskUseCaseUpdateTask(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err == nil && updatedTask.IsCompleted != tt.want.IsCompleted {
				t.Errorf("s.UpdateTask() IsCompleted = %v, want %v", updatedTask.IsCompleted, tt.want.IsCompleted)
			}
...
func TestTaskUseCaseMarkTaskCompleted(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err == nil && updatedTask.IsCompleted != tt.want.IsCompleted {
				t.Errorf("s.MarkTaskCompleted() IsCompleted = %v, want %v", updatedTask.Text, tt.want.Text)
			}
			if err == nil && updatedTask.UpdatedAt.IsZero() {
...
func TestTaskUseCaseMarkTaskNotCompleted(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if err == nil && updatedTask.IsCompleted != tt.want.IsCompleted {
				t.Errorf("s.MarkTaskNotCompleted() IsCompleted = %v, want %v", updatedTask.Text, tt.want.Text)
			}
			if err == nil && updatedTask.UpdatedAt.IsZero() {
